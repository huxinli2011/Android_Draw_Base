...
public class CanvasOprationView4 extends View {
    public CanvasOprationView4(Context context) {
        super(context);
    }

    public CanvasOprationView4(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CanvasOprationView4(Context context, AttributeSet attrs, int defStyle) {
