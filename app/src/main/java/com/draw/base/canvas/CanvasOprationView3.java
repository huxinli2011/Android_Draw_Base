...
public class CanvasOprationView3 extends View {
    public CanvasOprationView3(Context context) {
        super(context);
    }

    public CanvasOprationView3(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CanvasOprationView3(Context context, AttributeSet attrs, int defStyle) {
